...
function editPromotion(site: Site): void {
  router.push({ name: 'sites-promotion-email', params: { siteId: site.id } })
}
</script>
...
<template>
  <div class="space-y-4">
    <!-- Header -->
    <div>
      <h2 class="text-lg font-semibold text-gray-900">Promotion Emails</h2>
      <p class="text-sm text-gray-500">
        Edit the promotional offer email each site can send to its subscribers.
      </p>
    </div>
